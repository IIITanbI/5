namespace QA.AutomatedMagic
{
    ...
    public interface IManagingObjectFiller
    {
        ...
        object FillEditControls(object container, object obj, MetaType metaType, string name, bool isAssignableTypesAllowed);
        ...
        object FillEditControls(object container, object parentObj, MetaTypeObjectMember objectMember);
