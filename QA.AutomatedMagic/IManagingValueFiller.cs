namespace QA.AutomatedMagic
{
    ...
    public interface IManagingValueFiller
    {
        ...
        object FillEditControls(object container, object parentObj, MetaTypeValueMember valueMember);
        ...
        object FillEditControls(object container, object obj, string name);
